...
main() {
    ...
    sampler_support.center[0] = 10.0;
    sampler_support.center[1] = 10.0;
    ...
    region<2> obstacle_new, obstacle_new1, obstacle_new2;

    obstacle_new.center[0] = 12.0;
    obstacle_new.center[1] = 5.0;
    obstacle_new.size[0] = 4.0;
    obstacle_new.size[1] = 2.0;
    obstacle_new1.center[0] = 9.0;
    obstacle_new1.center[1] = 9.0;
    obstacle_new1.size[0] = 9.0;
    obstacle_new1.size[1] = 2.0;
    obstacle_new2.center[0] = 3.0;
    obstacle_new2.center[1] = 2.0;
    obstacle_new2.size[0] = 4.0;
    obstacle_new2.size[1] = 2.0;

    collision_checker1.add_obstacle(obstacle_new);
    collision_checker1.add_obstacle(obstacle_new1);
    collision_checker1.add_obstacle(obstacle_new2);

    collision_checker2.add_obstacle(obstacle_new);
    collision_checker2.add_obstacle(obstacle_new1);
    collision_checker2.add_obstacle(obstacle_new2);
    ...
    region_goal1.center[0] = 15.0;
    region_goal1.center[1] = 7.5;
    region_goal1.size[0] = 2.0;
    region_goal1.size[1] = 2.0;
    region<2> region_goal2;
    region_goal2.center[0] = 14;
    region_goal2.center[1] = 5.5;
    region_goal2.size[0] = 1.0;
    region_goal2.size[1] = 1.0;
    ...
    state_initial1->state_vars[0] = 8.5;
    state_initial1->state_vars[1] = 3.5;
    state_initial1->state_vars[2] = 1.5;
    state_initial2->state_vars[0] = 2.90;
    state_initial2->state_vars[1] = 7.3;
    state_initial2->state_vars[2] = 0;
    ////////////////////////////////////////////////////////////////////////////////////////
    ...
    //            radius=4;
    //            distance_evaluator2.find_near_vertices_r (z_e_new->state, radius, &list_vertices_in_ball);
    //            for (typename list<void*>::iterator iter = list_vertices_in_ball.begin(); iter != list_vertices_in_ball.end(); iter++) {
    //                vertex_t *vertex_curr = (vertex_t*)(*iter);
    //            //if( vertex_curr->data.visibility_cost>z_e_new->data.visibility_cost){
    //                if( vertex_curr->data.total_cost>z_e_new->data.total_cost){
    //                //planner2.delete_vertex(vertex_curr);   
    //                    vertex_curr->state->operator [](0)=state_initial2->operator [](0); 
    //                    vertex_curr->state->operator [](1)=state_initial2->operator [](1);
    //                    
    //                }
    //                     
    //            
    ...
    //            radius=4;
    //            distance_evaluator1.find_near_vertices_r (z_p_new->state, radius, &list_vertices_in_ball);
    //            for (typename list<void*>::iterator iter = list_vertices_in_ball.begin(); iter != list_vertices_in_ball.end(); iter++) {
    //                vertex_t *vertex_curr = (vertex_t*)(*iter);
    //            //if(vertex_curr->data.visibility_cost>z_p_new->data.visibility_cost){
    //                if(vertex_curr->data.total_cost>z_p_new->data.total_cost){
    //                //planner1.delete_vertex(vertex_curr);              
