...
main() {
    ...
    obstacle2.size[0] = 2.0;
    obstacle2.size[1] = 1.0;
    ...
    landmark_new2.center[0] = -4.0;
    landmark_new2.center[1] = -4.0;
    ...
    region_goal1.center[0] = 9.0;
    region_goal1.center[1] = 1.0;
    region_goal1.size[0] = 2.0;
    region_goal1.size[1] = 2.0;
    region<2> region_goal2;
    region_goal2.center[0] = 8.0;
    region_goal2.center[1] = -2.0;
    ...
    state_initial1->state_vars[0] = -8.0;
    state_initial1->state_vars[1] = 8.0;
    state_initial1->state_vars[2] = 0.0;
    state_initial2->state_vars[0] = -7.0;
    state_initial2->state_vars[1] = -6.0;
    ...
    // 3. RUN THE PLANNER
    double visible_range = 5, distance_range = 8;
    ...
    for (int i = 0; i < 500; i++) {
        ...
        if (planner2.isVisible(z_e_new->state, z_p_new->state) == 0) {
            //z_e_new->state->operator[](0) = state_initial1->operator[](0);
            //z_e_new->state->operator[](1) = state_initial1->operator[](1);
            z_e_new->data.visibility_cost += 1;
            z_e_new->data.total_cost = 50;
            planner1.updateCost(z_e_new, z_e_new->data.visibility_cost, 50);
            // z_p_new->state->operator[](0) = state_initial2->operator[](0);
            //z_p_new->state->operator[](1) = state_initial2->operator[](1);
            z_p_new->data.visibility_cost += 1;
            z_p_new->data.total_cost = 50;
            planner2.updateCost(z_p_new, z_p_new->data.visibility_cost, 50);

        } else {
            //z_e_new->state->operator[](0) = state_initial1->operator[](0);
            //z_e_new->state->operator[](1) = state_initial1->operator[](1);
            z_e_new->data.visibility_cost -= 1;
            z_e_new->data.total_cost = 1;
            planner1.updateCost(z_e_new, z_e_new->data.visibility_cost, 1);
            // z_p_new->state->operator[](0) = state_initial2->operator[](0);
            //z_p_new->state->operator[](1) = state_initial2->operator[](1);
            z_p_new->data.visibility_cost -= 1;
            z_p_new->data.total_cost = 1;
            planner2.updateCost(z_p_new, z_p_new->data.visibility_cost, 1);
